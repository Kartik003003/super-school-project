    ...
    const blogPosts = [
        {
            ...
            imageSrc: 'https://www.shutterstock.com/image-vector/elearning-concept-illustration-big-laptop-600nw-1259333059.jpg',
            modalContent: {
                text: [
...

        {
            ...
            imageSrc: 'https://www.dallasisd.org/cms/lib/TX01001475/Centricity/Domain/24296/Teachers.png',
            modalContent: {
                text: [
                                    ...
                                    <div className="row">
                                        {index % 2 === 0 ? (
                                            <>
                                                ...
                                                <div className="col-md-6 p-5 fade-right-enter">
